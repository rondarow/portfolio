...
<head>
    ...
    <header class="container">
        ...
        <main class="container">
            ...
            <div class="row">
                <div class="col-12">los siguientes trabajos que he realizado:</div>
            </div>
            <div class="row">
                <div class="col-12 col-sm-4 p-3">
                    <div class="proyecto">
                        ...
                        <div class="row my-5">
                            <div class="col-6 ps-4"><a href="" target="_blank" class="btn btn-rojo">Ver online</a></div>
                            <div class="col-6 text-center"><a href="" target="_blank" class="">Código Fuente</a></div>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-4 p-3">
