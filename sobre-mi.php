    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-5 col-12 mt-4">
                ...
                <p>Bienvenid@ a mi sitio web sobre docencia en sistemas.</p>
                <a href="contacto.php" class="btn btn-rojo">Enviar mensaje</a>
            </div>
            <div class="col-sm-3 col-12 mt-4 offset-sm-2">
                <img src="../portfolio/images/Ronald.jpeg" alt="Ronald David Pineda" title="Ronald David Pineda" class="img-fluid img-circle"></a>
            </div>
        </div>
    </div>
